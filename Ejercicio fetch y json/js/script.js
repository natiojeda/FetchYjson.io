...
fetch(DATA_URL)
  ...
  .then(data => {
    ...
    showData(students); // acá llama a la función showData para mostrar los nombres y apellidos
  })
  .catch(error => console.error('Error al cargar los datos:', error)); // muestra error si el fetch falla